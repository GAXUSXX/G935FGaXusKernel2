...
deps_drivers/cpufreq/exynos-mp-cpufreq.o := \
    ...
    $(wildcard include/config/cpu/thermal/ipa/debug.h) \
...
drivers/cpufreq/exynos-mp-cpufreq.o: $(deps_drivers/cpufreq/exynos-mp-cpufreq.o)
